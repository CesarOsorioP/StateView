...
const UserManagement = () => {
  ...
  const getAllowedRoles = () => {
    ...
    switch(user.rol) {
      case 'Superadministrador':
        return ['Usuario', 'Moderador', 'Administrador', 'Superadministrador', 'Critico'];
      case 'Administrador':
        return ['Usuario', 'Moderador', 'Critico'];
      case 'Moderador':
        return ['Usuario', 'Critico'];
      default:
        return ['Usuario'];
    }
  };
  ...
  const canEditUser = (targetUser) => {
    ...
    // Moderador puede editar usuarios regulares y críticos
    if (user.rol === 'Moderador') {
      return ['Usuario', 'Critico'].includes(targetUser.rol);
    }
  ...
  const canCreateUserWithRole = (role) => {
    ...
    // Moderador puede crear usuarios regulares y críticos
    if (user.rol === 'Moderador') {
      return ['Usuario', 'Critico'].includes(role);
    }
                  ...
                  <small className="input-help">
                    {user.rol === 'Superadministrador' 
                      ...
                      : user.rol === 'Administrador'
                        ...
                        : 'Puedes asignar roles de Usuario o Crítico'}
                  </small>
                </div>
